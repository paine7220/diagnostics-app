...
- Rebuild the main flow as **diagnose-first**: microphone + camera capture evidence, diagnosis picks one outcome, and repair instructions appear only for that finding (code, subsystem, how-to job, or engine rebuild). Browse libraries stay collapsed.
